...
class World:
    def __init__(
        ...
        # Set borders
        self.chess_board[0, :, 0] = True # sets top barrier by making the corresponding values in the 3-D array "1"
        self.chess_board[:, 0, 3] = True # same for left barrier
        self.chess_board[-1, :, 2] = True # -1 here means access the last element in that list
